...
from thonny.plugins.classroom.runtime import SAMPLES, language_for_path
...
class ClassroomTests(unittest.TestCase):
    ...
    def test_go_environment_disables_network_modules(self):
        env = GoAdapter("/app/go/bin/go", "/app/go", tempfile.mkdtemp()).build_environment(Path("main.go"))
